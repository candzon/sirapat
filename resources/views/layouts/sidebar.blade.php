        ...
        <div x-data="{ open: {{ request()->routeIs('kehadiran.*') ? 'true' : 'false' }} }" class="mt-4">
            ...
            <div x-show="open" 
                ...
                <a href="{{ route('kehadiran.index') }}" 
                   class="flex items-center px-8 py-2 hover:bg-blue-300 transition-colors duration-200 {{ request()->routeIs('kehadiran.index') ? 'bg-blue-300' : '' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>
                    Daftar Hadir
                ...
                <a href="{{ route('kehadiran.create') }}" 
                   class="flex items-center px-8 py-2 hover:bg-blue-300 transition-colors duration-200 {{ request()->routeIs('kehadiran.create') ? 'bg-blue-300' : '' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    Tambah Hadir
        ...
        <div x-data="{ open: {{ request()->routeIs('notulensi.*') ? 'true' : 'false' }} }" class="mt-4">
            ...
            <div x-show="open" 
                ...
                <a href="{{ route('notulensi.index') }}" 
                   class="flex items-center px-8 py-2 hover:bg-blue-300 transition-colors duration-200 {{ request()->routeIs('notulensi.index') ? 'bg-blue-300' : '' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>
                    Daftar Notulensi
        ...
        <div x-data="{ open: {{ request()->routeIs('undangan.*') ? 'true' : 'false' }} }" class="mt-4">
            ...
            <div x-show="open" 
                ...
                <a href="{{ route('undangan.index') }}" 
                   class="flex items-center px-8 py-2 hover:bg-blue-300 transition-colors duration-300 {{ request()->routeIs('undangan.index') ? 'bg-blue-300' : '' }}">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>
                    Daftar Undangan
