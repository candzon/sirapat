        ...
        <form action="{{ route('undangan.update', $undangan->id) }}" method="POST">
            ...
            <div class="bg-blue-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        class="tinymce-editor bg-blue-50 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        <option value="default" {{ old('template', $undangan->template) == "default" ? 'selected' : '' }}>
                            Default</option>
                        <option value="formal" {{ old('template', $undangan->template) == "formal" ? 'selected' : '' }}>
                            Formal</option>
                        <option value="casual" {{ old('template', $undangan->template) == "casual" ? 'selected' : '' }}>
                            Casual</option>
                    </select>
                </div>
                ...
                <!-- <div class="mb-4">
                    ...
                    <select
                        ...
                        <option value="draft" {{ old('status', $undangan->status) == "draft" ? 'selected' : '' }}>draft
                        </option>
