@extends('layouts.app')
@section('title', 'Jenis Rapat')
@section('content')
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Jenis Rapat</h1>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    @forelse($jenis_rapats as $jenis)
                        <tr class="border-b border-blue-100 hover:bg-blue-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <form action="{{ route('rapat.jenis.destroy', $jenis->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                    ...
                    @empty
                        <tr class="border-b border-gray-200">
                            <td class="py-3 px-6 text-center" colspan="3">Tidak ada data jenis rapat</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
