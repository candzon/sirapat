...
@section('content')
    <div class="grid grid-cols-4 gap-4 mb-8">
        <div class="bg-blue-100 p-6 rounded-lg shadow">
            <h3 class="text-blue-500 text-sm">Total Rapat</h3>
            <p class="text-4xl font-bold">{{ $total_rapat }}</p>
        </div>
        
        <div class="bg-blue-100 p-6 rounded-lg shadow">
            <h3 class="text-blue-500 text-sm">Rapat Hari Ini</h3>
            <p class="text-4xl font-bold">{{ $rapat_hari_ini }}</p>
        </div>
        
        <div class="bg-blue-100 p-6 rounded-lg shadow">
            <h3 class="text-blue-500 text-sm">Total OPD</h3>
            <p class="text-4xl font-bold">{{ $total_opd }}</p>
        </div>
        
        <div class="bg-blue-100 p-6 rounded-lg shadow">
            <h3 class="text-blue-500 text-sm">Total Peserta</h3>
            <p class="text-4xl font-bold">{{ $total_kehadiran }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div class="bg-blue-100 p-6 rounded-lg shadow">
            ...
            <div class="space-y-4">
                ...
                <div class="border-b bg-blue-200 pb-2">
                    <p class="text-sm text-blue-600">{{ $aktivitas['time'] }}</p>
