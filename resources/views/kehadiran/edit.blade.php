<form action="{{ route('kehadiran.update', $kehadiran->id) }}" method="POST">
    ...
    <div class="bg-blue-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <div class="mb-4">
            ...
            <input
                class="bg-blue-50 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                id="nama" type="text" name="nama" value="{{ old('nama', $kehadiran->user->name) }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                value="{{ old('tanggal', $kehadiran->tanggal->format('Y-m-d')) }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <select
                ...
                <option value="hadir" {{ old('keterangan', $kehadiran->keterangan) == "hadir" ? 'selected' : '' }}>hadir
                </option>
            </select>
        </div>
    </div>
